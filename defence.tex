...
\begin{document}
  ...
  \subfile{slides/slide_7.tex} % error resolved
  \subfile{slides/slide_8.tex}
  \subfile{slides/slide_9.tex} % error resolved
  \subfile{slides/slide_10.tex}
  \subfile{slides/slide_11.tex}
  \subfile{slides/slide_12.tex}
  \subfile{slides/slide_13.tex}
  \subfile{slides/slide_14.tex} % error resolved
  \subfile{slides/slide_14-5.tex}
  \subfile{slides/slide_15.tex} % error resolved
  \subfile{slides/slide_16.tex}
  \subfile{slides/slide_17.tex}
  \subfile{slides/slide_18.tex} % error resolved
  \subfile{slides/slide_19.tex} % error resolved
  ...
  \subfile{slides/slide_25-5.tex}
  \subfile{slides/slide_25-75.tex}
  \subfile{slides/slide_26.tex}
  \subfile{slides/slide_27.tex}
  \subfile{slides/slide_28.tex}
  \subfile{slides/slide_29.tex}
  \subfile{slides/slide_30.tex}
  \subfile{slides/slide_31.tex}
