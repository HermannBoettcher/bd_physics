    ...
    \begin{tikzpicture}[scale=0.7, transform shape,
            ...
            \begin{scope}
                ...
                \begin{pgfonlayer}{bg}    % select the background layer
                    ...
                    \path [draw = none, fill = white](2.8,4) arc[start angle = -180, end angle = 0, radius=0.7cm];
                    \path [draw = none, fill = white](2.8,-0.5) arc[start angle = 180, end angle = 0, radius=0.7cm];
                    %emptying
                    \fill[blue!50] (6.3,0) -- (6.3,3.5)  -- (7.7,3.5) -- (7.7,0) -- cycle ;
                    \path [draw = none, fill = white](6.5,3.6) arc[start angle = -180, end angle = 0, radius=0.5cm];
                    \path [draw = none, fill = white](6.5,-0.1) arc[start angle = 180, end angle = 0, radius=0.5cm];
