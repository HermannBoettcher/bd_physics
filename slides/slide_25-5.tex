...
\begin{document}
  \begin{frame}{Testing the ALD process}
    \scalebox{0.65}{
      ...
      \begin{tikzpicture}
          ...
          \fill[rectangle,green!50] (10,-3) rectangle (11,-4) node[pos=.5,color=black,align=center] {c'\\ \faLineChart\hfill\faBinoculars};
          \fill[rectangle,green!50] (11.5,-3) rectangle (14.5,-4) node[pos=.5,color=black,align=center] {h', i', j', k', l'};
