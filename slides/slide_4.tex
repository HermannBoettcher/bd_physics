    ...
    \begin{tikzpicture}[scale=0.7, transform shape,
          ...
          \begin{scope}
              ...
              \begin{pgfonlayer}{bg}    % select the background layer
                  ...
                  \path [draw = none, fill = white](9.1,4) arc[start angle = -180, end angle = 0, radius=0.7cm];
                  \path [draw = none, fill = white](9.1,-0.5) arc[start angle = 180, end angle = 0, radius=0.7cm];
                  %full pore
