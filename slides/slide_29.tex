...
\begin{document}
  \begin{frame}{Transmission \& pore disorder theory}
    \begin{columns}[onlytextwidth, c]
      \column{\dimexpr\linewidth / 21 * 10}
        ...
        \begin{tiny}
          Transmission drops for membranes of wafer 292 and before
          \pause
          \begin{itemize}
      ...
      \column{\dimexpr\linewidth / 21 * 10}
        \scalebox{0.38}{
          ...
          \begin{tikzpicture}
              ...
              \def\funneling{0.7}
              \node[anchor=east, minimum width=3cm] at (-.5,3) {Condensation};
        ...
        \scalebox{0.38}{
          ...
          \begin{tikzpicture}
              ...
              \def\rmax{0.29}
              \def\funneling{0.7}
              \node[anchor=east, minimum width=3cm] at (-.5,3) {Evaporation};
